...
def add_any_new_vids_to_archive(vid_id_list, used, archive):
    ...
    used_vids = used #[] if archive['used'] == None else archive['used'] 
    ...
    new_vids = list(set([x.strip() for x in combo if x not in vid_id_list])) #first thing has to have the new things
...
def grab_next_video(archive, used, yt_playlist):
...
if __name__ == "__main__":
    ...
    vid = grab_next_video(r"D:\Git\Slack-Video-of-the-Day\slack_archive_BLM.txt", r"D:\Git\Slack-Video-of-the-Day\used.txt", playlist_items)
    msg = r"Black Lives Matter. https://www.youtube.com/watch?v=" + vid.strip()
